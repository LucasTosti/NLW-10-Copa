...
document.querySelector("#cards").innerHTML = 
    ...
    createCard("24/11", "quinta", createGame("switzerland", "17:00", "cameroon") + createGame("uruguay", "10:00", "south korea") + createGame("portugal", "10:00", "ghana") + createGame("brazil", "10:00", "serbia")) +

    createCard("28/11", "segunda", createGame("switzerland", "16:00", "brazil") + 
